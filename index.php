...
<body>
  ...
  <?php
    $qry = "SELECT * FROM `theme` WHERE `id`='1'";
    ...
    <section id="home" class="p-0 container">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <?php
                      $qry = "SELECT * FROM `event` WHERE `types`='image' AND `branch`='Chennai' ORDER BY `year` DESC";
                      $run = mysqli_query($con,$qry);
                        ...
                        if ($count<4) {
                          if ($count==1) {
                            ...
                            <div class="carousel-item active">
                             <img class="d-block w-100" src="<?php echo 'dashboard/'.$years['image'];?>" height="600px">
                            </div>             
                            <?php
                          }
                          else{
...
<section class="container youtube">
  ...
  <div class="row">
    ...
    <?php
      $qry = "SELECT * FROM `event` WHERE `types`='video' AND `branch`='Chennai' ORDER BY `year` DESC";
      $run = mysqli_query($con,$qry);
...
<p><br></p>
 ...
 <!-- Story Section -->
  ...
  <section class="container-fluid">
    ...
    <div class="row">
      <?php
        $qry = "SELECT * FROM `story` WHERE `branch`='Chennai' ORDER BY `id` DESC";
        $run = mysqli_query($con,$qry);
        $count = 0;
