...
<body>
  ...
  <?php
    $qry = "SELECT * FROM `event` WHERE `branch`='Solapur' ORDER BY `year` DESC";
...
<section class="container-fluid" style="margin-top: 200px;">
  ...
  <div class="row" id="events">
    <?php
    $qry = "SELECT * FROM `event` WHERE `branch`='Solapur' AND `year`='$c_year'";
  $run = mysqli_query($con,$qry);
...
<div id="myModal" class="modal-gl">
  ...
  <?php
    $qry1 = "SELECT * FROM `event` WHERE `branch`='Solapur' AND `year`='$c_year'";
