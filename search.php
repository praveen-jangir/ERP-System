...
<section class="container-fluid" style="margin-top: 200px;">
  <center>
    <div class="row">
      <?php
      //for Member
        $qry1 = "SELECT * FROM `member` WHERE `keyword` LIKE '%$search%' AND `admin`='0' AND `branch`='Chennai'";
        ...
        while ($mem = mysqli_fetch_assoc($run1)) {
              ...
              <div class="row">
                <div class="col-sm-6 col-md-6">
                  ...
                  if (isset($_SESSION['uid'])) {
                    ?> 
                    <p align="right" data-toggle="modal" data-target="#<?php echo $mem['first_name'];?><?php echo $mem['id'];?>">&#128279;</p>
                    <?php
                  }
                  else{
                    ?>
          ...
          <!-- Modal for links -->
      <div class="modal fade" id="<?php echo $mem['first_name'];?><?php echo $mem['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog" role="document">
        ...
        //for Honrary
        $qry = "SELECT * FROM `honrary` WHERE `keyword`LIKE '%$search%' AND `branch`='Chennai'";
        ...
        while ($mem = mysqli_fetch_assoc($run)) {
            ...
            <div class="member-card">
              <div class="row">
                <div class="col-sm-6 col-md-6">
                  ...
                  if (isset($_SESSION['uid'])) {
                    ?> 
                    <p align="right" data-toggle="modal" data-target="#<?php echo $mem['name'];?><?php echo $mem['id'];?>">&#128279;</p>
                    <?php
                  }
                  else{
                    ?>
          ...
          <!-- Modal for links -->
      <div class="modal fade" id="<?php echo $mem['name'];?><?php echo $mem['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
